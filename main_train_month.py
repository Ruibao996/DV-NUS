...
train_scaler_square_save_path = './result/model/scaler_square_month.npy'


train_main_month(train_input_path, train_model_save_path, train_scaler_followers_save_path, train_scaler_price_save_path, train_scaler_total_price_save_path, train_scaler_square_save_path)
